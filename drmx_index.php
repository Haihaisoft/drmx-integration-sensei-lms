      ...
      <form name="postForm" action="drmx_login.php" method="post">
         <div class="login-cont">
            ...
            <div class="login-foot">
               <div class="foot-acts">
                  Please login to your account and get a license. If you do not buy a course, please visit our website. <a href="<?php echo esc_attr(site_url()) ?>" target="_blank"><?php echo esc_attr(site_url()) ?></a>
               </div>
            </div>
         </div>
	   </form>
