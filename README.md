...
- **drmx-integration-sensei-lms.php** Plug-in registration file.
- **drmx-integration-sensei-lms-settings.php** Plug-in settings page.
...
## 2. Associate Sensei LMS courses with DRM-X 4.0 License Profile

### 1. Create or edit Sensei LMS Courses
...
Embed the protected video into the Sensei LMS course. Create or edit a Lesson for a Sensei LMS course. Embed the encrypted video using the following shortcode. [xvast-player] https://www.domainname.com/videos/xxxxx_P.mp4 [/xvast-player]
...
Set the **License URL**: The URL starts with the domain name of your WordPress site, for example: https://www.domain.com/wp-content/plugins/drmx-integration-sensei-lms/drmx_index.php You can also check the DRM-X 4.0 with Sensei LMS plugin page for a line of blue URL, which is the address of your website to get the license.
